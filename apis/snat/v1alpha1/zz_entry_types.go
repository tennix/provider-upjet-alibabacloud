...
type EntryInitParameters struct {
	...
	// Reference to a Address in eip to populate snatIp.
	// +kubebuilder:validation:Optional
	SnatIPRef *v1.Reference `json:"snatIpRef,omitempty" tf:"-"`

	// Selector for a Address in eip to populate snatIp.
	// +kubebuilder:validation:Optional
	...
	// Reference to a Gateway in nat to populate snatTableId.
	// +kubebuilder:validation:Optional
	SnatTableIDRef *v1.Reference `json:"snatTableIdRef,omitempty" tf:"-"`

	// Selector for a Gateway in nat to populate snatTableId.
	// +kubebuilder:validation:Optional
...
// Entry is the Schema for the Entrys API. Provides a Alicloud snat resource.
